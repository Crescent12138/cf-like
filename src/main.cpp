...
class QueueServiceImpl : public suggest::QueueService {
public:
    QueueServiceImpl() {}
...
int main(int argc, char* argv[]) {
    ...
    suggest::FileServiceImpl file_svc;
    suggest::QueueServiceImpl queue_svc;
    suggest::HttpSSEServiceImpl sse_svc;
